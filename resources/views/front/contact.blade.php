			...
			<div class="row">
				<div class="col-lg-7 col-xl-8">
					<div class="form_grid">
			            ...
			            <form class="contact_form" id="frmcontact"  method="post" >
						  @csrf
							<div class="row">
				                <div class="col-md-6">
				                    <div class="form-group">
										<input id="form_name" name="name" class="form-control"  type="text" placeholder="Name" required>
									</div>
				                </div>
				                <div class="col-md-6">
				                    <div class="form-group">
				...
				<div class="col-lg-5 col-xl-4">
					<div class="contact_localtion">
						...
						<div class="content_list">
							<h5>Address</h5>
							<p>201,Radhe shyam Apartment<br>Gujarat 394105</p>
						</div>
						<div class="content_list">
							<h5>Phone</h5>
							<p>7069224753</p>
						...
						<div class="content_list">
							<h5>Mail</h5>
							<p><a href="https://grandetest.com/cdn-cgi/l/email-protection" class="__cf_email__" data-cfemail="70191e161f3016191e14181f0503155e131f1d">niravgorasiya10@gmail.com</a></p>
						</div>
						<div class="content_list">
							<h5>Skype</h5>
							<p>findhouse.com</p>
