...
<div class="col-lg-12">
    <div class="my_dashboard_review">
        <div class="row">
            ...
            <div class="col-xl-10">
                <form action="{{route('/user/profile/add')}}" name="myform" onsubmit="return validate()" method="post"enctype="multipart/form-data">
                @csrf
...
if (username==null ||username ==""){  
    ...
    if (about==null ||about ==""){  
    document.getElementById("descript").innerHTML="Please Enter About";  
    return false; 
    }
    else{  
