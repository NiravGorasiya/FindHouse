...
<div class="wrapper">
    ...
    <div class="dashboard_sidebar_menu dn-992">
	    <ul class="sidebar-menu">
	    	...
	    	<li class="treeview"><a href="{{url('agent/dashboard')}}"><i class="flaticon-layers"></i><span> Dashboard</span></a></li>
	      	...
	      	<li class="treeview">
		        ...
		        <ul class="treeview-menu">
		        	<li><a href="{{url('agent/property/display')}}"><i class="fa fa-circle"></i>Property view</a></li>
		        	<li><a href="{{url('agent/property')}}"><i class="fa fa-circle"></i>Property Add</a></li>
		        </ul>
	      	</li>
	      
			  <li><a href="{{('/agent/wishlist')}}"><i class="flaticon-heart"></i> <span> My Favorites</span></a></li>
	     	<li class="treeview">
		        <a href="page-my-review.html"><i class="flaticon-chat"></i><span> Reviews</span><i class="fa fa-angle-down pull-right"></i></a>
		        <ul class="treeview-menu">
		        	<li><a href="{{url('review/agentdetails')}}"><i class="fa fa-circle"></i> My Reviews</a></li>
		        	<li><a href=""><i class="fa fa-circle"></i> Visitor Reviews</a></li>
		        </ul>
	      	</li>
	   		<li class="title"><span>Manage Account</span></li>
			<li><a href="{{url('agent/profile')}}"><i class="flaticon-user"></i> <span>My Profile</span></a></li>
